...
{ 
  ...
  Q_PROPERTY(bool disableUpdateValueFlag READ  disableUpdateValueFlag WRITE setDisableUpdateValueFlag)
...
public:
  ...
  bool disableUpdateValueFlag() const;
...
public slots:
  ...
  void setDisableUpdateValueFlag(bool disable);
